    ...
    <div className="p-6 max-w-7xl mx-auto space-y-8 text-slate-900 dark:text-slate-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          >
            <div className={`w-36 h-36 rounded-full border-4 flex flex-col items-center justify-center bg-slate-900 shadow-inner ${
              overallStatus === 'Ready'
          ...
          {/* Disclaimer text */}
          <p className="text-[11px] text-slate-400 mt-4 leading-normal italic px-2">
            “The ML Readiness Score is an analytical risk indicator generated by this application. It should support human review rather than replace it.”
          </p>
        </motion.div>
        ...
        >
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between border-b border-slate-700/80 pb-4 gap-2">
            ...
            <button
              ...
              className="px-3.5 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg font-bold text-xs shadow transition-all shrink-0"
            >
              Export Full Report
            </button>
          </div>
